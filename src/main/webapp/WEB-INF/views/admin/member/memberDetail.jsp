...
<script>
	function fn_modify_member_info(member_id, mod_type) {
		...
		$
				.ajax({
					...
					url : "http://localhost:8070/jaeshop/admin/member/modifyMemberInfo.do",
					data : {
						member_id : member_id,
						mod_type : mod_type,
						value : value
	...
	function fn_delete_member(member_id, del_yn) {
		...
		frm_mod_member.action = "/jaeshop/admin/member/deleteMember.do";
			...
			<table>
				<tbody>
					...
					<tr class="dot_line">
						...
						<td><input name="member_birth" type="text" size="20"
							value="${member_info.member_birth }" /></td>
						<td><input type="button" value="수정하기"
						...
						<td><input type="text" id="zipcode" name="zipcode" size=5
							...
							<p>
								...
								도로명 주소: <input type="text" id="jibunAddress" name="jibunAddress"
									size="50" value="${member_info.jibunAddress }"><br>
