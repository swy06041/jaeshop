		...
		for (var i = 0; i < r_pay_method.length; i++) {
			if (r_pay_method[i].checked == true) {
				...
				if (pay_method == "신용카드") {
					...
					var i_pay_order_hp1 = document
							.getElementById("pay_order_hp1");
			...
			<table>
				<tbody>
					...
					<tr class="dot_line">
						...
						<td><input type="hidden" id="h_hp1" name="h_hp1"
							value="${orderer.hp1 }" /> <c:set var="orderer_hp"
								value="${orderer.hp1}" />
					</tr>
		...
		<div>
			...
			<table>
				<tbody>
					...
					<tr class="dot_line">
						<td><h2>핸드폰</h2></td>
						<td><input type="text" value="${orderer.hp1}" size="15" /></td>
					</tr>
					<tr class="dot_line">
						<td><h2>이메일</h2></td>
						<td><input type="text"
				...
				<tbody>
					...
					<tr id="tr_pay_phone" style="visibility: hidden">
						<td><strong>휴대폰 번호 입력: <strong> <input
									type="text" size="15" value="" id="pay_order_hp1" name="hp1" /></td>
					</tr>
				</tbody>
			</table>
		</div>
