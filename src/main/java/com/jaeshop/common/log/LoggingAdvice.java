package com.jaeshop.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.jaeshop.*.service.*.*(..)) or "
			+ "execution(* com.jaeshop.*.dao.*.*(..))")
	...
	@After("execution(* com.jaeshop.*.service.*.*(..)) or "
			+ "execution(* com.jaeshop.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.jaeshop.*.service.*.*(..)) or "
			+ "execution(* com.jaeshop.*.dao.*.*(..))")
